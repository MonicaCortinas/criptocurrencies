...
### **<i class="fa fa-bitcoin"></i>** Bitcoin aplicación descentralizada para realizar pagos. No la única aplicación posible de la descentralización
...
## <i class="fa fa-facebook-square"></i>acebook y <i class="fa fa-amazon"></i>mazon pueden ser los siguientes
...
| <a href="http://criptomcortinas.updog.co/#1" target="_blank"><i class="fa fa-link"></i> </a>     |.grey[http://criptomcortinas.updog.co/#1]|
